...
def makeBackgroundValidation(lumi, treeMC, var, name, xlabel, logx, LLlabel = False):
...
if __name__ == "__main__":
    ...
    makeBackgroundValidation(lumi, treeMC, 'EEsel_minIxy', 'EEsel_minIxy', '|d_{0}|/#sigma_{d}', 1, 'EE')
    ...
    makeBackgroundValidation(lumi, treeMC, 'MMsel_minIxy', 'MMsel_minIxy', '|d_{0}|/#sigma_{d}', 1, 'MM')
