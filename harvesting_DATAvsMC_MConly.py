...
def makeDataMCPlot(lumi, hname_DATA, hname_MC, ylog, treeDATA, treeMC, inputdir, hname_extra = '', label_extra = '', treeEXTRA = False, xlabel = '', outtag = '', yshift = 100.0, LLlabel = '', leftlabel = '', xlog = False, outdir = '', sys_errors = None):
    ...
    plot.saveRatio(1, 1, ylog, luminosity, hDATA, hMCtotal, r_ymin = 0.0, r_ymax = 2.0, label="Data/BKG", outputDir = outfolder, xlog = xlog, inProgress = True, hsys = hsys)
...
if __name__ == "__main__":
    ...
    #DoubleEG2016_APV.append('DoubleEG_Run2016F_noHIPM')
    ...
    www = '/eos/user/f/fernance/www/DisplacedLeptons-analysis/Data-vs-MonteCarlo/ThesisPlots_allLO'
    ...
    if True:
        ...
        # electrons
        makeDataMCPlot(lumi = lumi2016, hname_DATA = 'hEEBCR_nEE', hname_MC = 'hEEBCR_nEE', ylog = True, treeDATA = treeDATA_EG2016, treeMC = treeMC_postVFP, inputdir = opts.input, hname_extra = '', label_extra = 'SS background', treeEXTRA = treeDATA_EG2016, xlabel = '', outtag = '2016', yshift = 1000.0, leftlabel = 'Control Region: |#Delta#Phi| > #pi/2', LLlabel = 'EE', xlog = False, outdir = www, sys_errors = sys['EE_2016'])
        makeDataMCPlot(lumi = lumi2016, hname_DATA = 'hEEBCR_mass', hname_MC = 'hEEBCR_mass', ylog = True, treeDATA = treeDATA_EG2016, treeMC = treeMC_postVFP, inputdir = opts.input, hname_extra = '', label_extra = 'SS background', treeEXTRA = treeDATA_EG2016, xlabel = '', outtag = '2016', yshift = 1000.0, leftlabel = 'Control Region: |#Delta#Phi| > #pi/2', LLlabel = 'EE', xlog = False, outdir = www, sys_errors = sys['EE_2016'])
        makeDataMCPlot(lumi = lumi2016, hname_DATA = 'hEEBCR_MET', hname_MC = 'hEEBCR_MET', ylog = True, treeDATA = treeDATA_EG2016, treeMC = treeMC_postVFP, inputdir = opts.input, hname_extra = '', label_extra = 'SS background', treeEXTRA = treeDATA_EG2016, xlabel = '', outtag = '2016', yshift = 1000.0, leftlabel = 'Control Region: |#Delta#Phi| > #pi/2', LLlabel = 'EE', xlog = False, outdir = www, sys_errors = sys['EE_2016'])
        makeDataMCPlot(lumi = lumi2016, hname_DATA = 'hEEBCR_mass_Z', hname_MC = 'hEEBCR_mass_Z', ylog = True, treeDATA = treeDATA_EG2016, treeMC = treeMC_postVFP, inputdir = opts.input, hname_extra = '', label_extra = 'SS background', treeEXTRA = treeDATA_EG2016, xlabel = '', outtag = '2016', yshift = 1000.0, leftlabel = 'Control Region: |#Delta#Phi| > #pi/2', LLlabel = 'EE', xlog = False, outdir = www, sys_errors = sys['EE_2016'])
        makeDataMCPlot(lumi = lumi2016, hname_DATA = 'hEEBCR_leadingEt', hname_MC = 'hEEBCR_leadingEt', ylog = True, treeDATA = treeDATA_EG2016, treeMC = treeMC_postVFP, inputdir = opts.input, hname_extra = '', label_extra = 'SS background', treeEXTRA = treeDATA_EG2016, xlabel = '', outtag = '2016', yshift = 1000.0, leftlabel = 'Control Region: |#Delta#Phi| > #pi/2', LLlabel = 'EE', xlog = False, outdir = www, sys_errors = sys['EE_2016'])
        makeDataMCPlot(lumi = lumi2016, hname_DATA = 'hEEBCR_subleadingEt', hname_MC = 'hEEBCR_subleadingEt', ylog = True, treeDATA = treeDATA_EG2016, treeMC = treeMC_postVFP, inputdir = opts.input, hname_extra = '', label_extra = 'SS background', treeEXTRA = treeDATA_EG2016, xlabel = '', outtag = '2016', yshift = 1000.0, leftlabel = 'Control Region: |#Delta#Phi| > #pi/2', LLlabel = 'EE', xlog = False, outdir = www, sys_errors = sys['EE_2016'])
        ...
        makeDataMCPlot(lumi = lumi2016, hname_DATA = 'hMMBCR_eta', hname_MC = 'hMMBCR_eta', ylog = True, treeDATA = treeDATA_Mu2016, treeMC = treeMC_2016, inputdir = opts.input, hname_extra = '', label_extra = 'SS background', treeEXTRA = treeDATA_Mu2016, xlabel = '', outtag = '2016', yshift = 1000.0, leftlabel = 'Control Region: |#Delta#Phi| > #pi/2', LLlabel = 'MM', xlog = False, outdir = www, sys_errors = sys['MM_2016'])
