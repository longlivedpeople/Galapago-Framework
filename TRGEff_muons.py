...
if __name__ == "__main__":
    ...
    outputPath =  WORKPATH + 'TRGEff_muons/' if not opts.tag else WORKPATH + 'TRGEff_muons_' + opts.tag + '/'
    ...
    for i in range(0, _tree.GetEntries()):
        ...
        for l in range(_tree.nGenLepton):
            ...
            if not abs(_tree.GenLeptonSel_pdgId[l]) == 13: continue
        ...
        if pt1_cut and pt2_cut and dRcut and eta1_cut and eta2_cut: # pt cuts only
            ...
            eff_pt1.Fill(_tree.Flag_HLT_L2DoubleMu28_NoVertex_2Cha_Angle2p5_Mass10, pt1)
            eff_pt2.Fill(_tree.Flag_HLT_L2DoubleMu28_NoVertex_2Cha_Angle2p5_Mass10, pt2)
            eff_pt_12.Fill(_tree.Flag_HLT_L2DoubleMu28_NoVertex_2Cha_Angle2p5_Mass10, pt1, pt2)
            ...
            eff_pt1Lxy1.Fill(_tree.Flag_HLT_L2DoubleMu28_NoVertex_2Cha_Angle2p5_Mass10, pt1, Lxy1)
            eff_pt2Lxy2.Fill(_tree.Flag_HLT_L2DoubleMu28_NoVertex_2Cha_Angle2p5_Mass10, pt2, Lxy2)


            eff_dR.Fill(_tree.Flag_HLT_L2DoubleMu28_NoVertex_2Cha_Angle2p5_Mass10, dR)
            eff_mass.Fill(_tree.Flag_HLT_L2DoubleMu28_NoVertex_2Cha_Angle2p5_Mass10, mass)
        
            eff_eta_12.Fill(_tree.Flag_HLT_L2DoubleMu28_NoVertex_2Cha_Angle2p5_Mass10, abs(eta1), abs(eta2))
