...
def passedPhotonTrigger(ev, year):
    ...
    if year == '2016':
        #passed = ev.HLT_Photon42_R9Id85_OR_CaloId24b40e_Iso50T80L_Photon25_AND_HE10_R9Id65_Eta2_2016Full or ev.HLT_Diphoton30_18_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90 or ev.HLT_Diphoton30PV_18PV_R9Id_AND_IsoCaloId_AND_HE_R9Id_DoublePixelVeto_Mass55
        passed = ev.HLT_Photon42_R9Id85_OR_CaloId24b40e_Iso50T80L_Photon25_AND_HE10_R9Id65_Eta2_Mass15 or ev.HLT_Diphoton30_18_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90
        #passed = ev.HLT_Photon42_R9Id85_OR_CaloId24b40e_Iso50T80L_Photon25_AND_HE10_R9Id65_Eta2_2016Full
...
if __name__ == "__main__":
    ...
    outputFile = TFile(EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/TH1F_photontrigger_'+era+'.root', 'RECREATE')
    for key in plot.keys():
        plot[key].Write()
    ...
    canvas.saveRatio(1, 1, 0, '', hdata = hdata_, hMC = hMC_, r_ymin = 0.7, r_ymax = 1.0, label = 'Scale factor',outputDir = EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/', inProgress = False)
    ...
    canvas.addLatex(0.9, 0.88, era, size = 0.035, align = 31)
    canvas.saveRatio(1, 1, 0, '', hdata = hdata_, hMC = hDYJetsToLL_M50_, r_ymin = 0.7, r_ymax = 1.0, label = 'Scale factor',outputDir = EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/', inProgress = False)
    ...
    canvas.addLatex(0.9, 0.88, era, size = 0.035, align = 31)
    canvas.saveRatio(1, 1, 0, '', hdata = hdata_, hMC = hTTTo2L2Nu_, r_ymin = 0.7, r_ymax = 1.0, label = 'Scale factor',outputDir = EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/', inProgress = False)
    ...
    canvas.addLatex(0.9, 0.88, era, size = 0.035, align = 31)
    canvas.saveRatio(1, 1, 0, '', hdata = hdata_, hMC = hDYJetsToLL_, r_ymin = 0.7, r_ymax = 1.0, label = 'Scale factor',outputDir = EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/', inProgress = False)
    ...
    canvas.save(1, 1, 0, '', '', ymin=0.65, ymax=1.2, outputDir = EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/', inProgress = False)
    ...
    canvas.save(0, 1, 0, '', '', outputDir = EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/', inProgress = False, is2d = True, labelz = 'Efficiency')
    ...
    canvas.addLatex(0.8, 0.93, era, size = 0.035, align = 31)
    canvas.save(0, 0, 0, '', '', outputDir = EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/', inProgress = False, is2d = True, labelz = 'Efficiency')
    ...
    canvas.addLatex(0.8, 0.93, era, size = 0.035, align = 31)
    canvas.save(0, 1, 0, '', '', outputDir = EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/', inProgress = False, is2d = True, labelz = 'Scale factor')
    ...
    canvas.addLatex(0.8, 0.93, era, size = 0.035, align = 31)
    canvas.save(0, 1, 0, '', '', outputDir = EOSPATH + 'PhotonTrigger-SFs_2016Full_DYOptimized/', inProgress = False, is2d = True, labelz = 'Scale factor uncertainty (stat)')
