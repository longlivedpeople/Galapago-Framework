...
if __name__ == "__main__":
    ...
    outputFile = TFile(EOSPATH + 'PhotonTrigger-SFs_2017Full_m90/TH1F_photontrigger_'+era+'.root', 'RECREATE')
    for key in plot.keys():
        plot[key].Write()
    ...
    canvas.saveRatio(1, 1, 0, '', hdata = hdata_, hMC = hMC_, r_ymin = 0.7, r_ymax = 1.0, label = 'Scale factor',outputDir = EOSPATH + 'PhotonTrigger-SFs_2017Full_m90/', inProgress = False)
    ...
    canvas.addLatex(0.9, 0.88, era, size = 0.035, align = 31)
    canvas.saveRatio(1, 1, 0, '', hdata = hdata_, hMC = hDYJetsToLL_M50_, r_ymin = 0.7, r_ymax = 1.0, label = 'Scale factor',outputDir = EOSPATH + 'PhotonTrigger-SFs_2017Full_m90/', inProgress = False)
    ...
    canvas.addLatex(0.9, 0.88, era, size = 0.035, align = 31)
    canvas.saveRatio(1, 1, 0, '', hdata = hdata_, hMC = hTTTo2L2Nu_, r_ymin = 0.7, r_ymax = 1.0, label = 'Scale factor',outputDir = EOSPATH + 'PhotonTrigger-SFs_2017Full_m90/', inProgress = False)
    ...
    canvas.save(1, 1, 0, '', '', ymin=0.65, ymax=1.2, outputDir = EOSPATH + 'PhotonTrigger-SFs_2017Full_m90/', inProgress = False)
    ...
    canvas.save(0, 1, 0, '', '', outputDir = EOSPATH + 'PhotonTrigger-SFs_2017Full_m90/', inProgress = False, is2d = True, labelz = 'Efficiency')
    ...
    canvas.addLatex(0.8, 0.93, era, size = 0.035, align = 31)
    canvas.save(0, 0, 0, '', '', outputDir = EOSPATH + 'PhotonTrigger-SFs_2017Full_m90/', inProgress = False, is2d = True, labelz = 'Efficiency')
    ...
    canvas.addLatex(0.8, 0.93, era, size = 0.035, align = 31)
    canvas.save(0, 1, 0, '', '', outputDir = EOSPATH + 'PhotonTrigger-SFs_2017Full_m90/', inProgress = False, is2d = True, labelz = 'Scale factor')
    ...
    canvas.addLatex(0.8, 0.93, era, size = 0.035, align = 31)
    canvas.save(0, 1, 0, '', '', outputDir = EOSPATH + 'PhotonTrigger-SFs_2017Full_m90/', inProgress = False, is2d = True, labelz = 'Scale factor uncertainty (stat)')
