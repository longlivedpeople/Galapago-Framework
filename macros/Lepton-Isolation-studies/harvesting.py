...
if __name__ == "__main__":
    ...
    plot = Canvas.Canvas('hist_electron_relTrkIso', 'png,pdf', 0.32, 0.55, 0.67, 0.89, 1, lsize=0.028)
    plot.addHisto(hist_bkg, 'HIST', 'Background: Hadronic WZ, WW decays', 'f', '', 1, 0)
    plot.addHisto(hist_125_30_1, 'HIST,SAME', 'H#rightarrowSS (125 GeV, 30 GeV, 1 mm)', 'l', '', 1, 1)
    plot.addHisto(hist_125_30_10, 'HIST,SAME', 'H#rightarrowSS (125 GeV, 30 GeV, 10 mm)', 'l', '', 1, 2)
    plot.addHisto(hist_125_30_100, 'HIST,SAME', 'H#rightarrowSS (125 GeV, 30 GeV, 100 mm)', 'l', '', 1, 3)
    plot.addHisto(hist_400_50_1, 'HIST,SAME', 'H#rightarrowSS (400 GeV, 50 GeV, 1 mm)', 'l', '', 1, 4)
    plot.addHisto(hist_400_50_10, 'HIST,SAME', 'H#rightarrowSS (400 GeV, 50 GeV, 10 mm)', 'l', '', 1, 5)
    plot.addHisto(hist_400_50_100, 'HIST,SAME', 'H#rightarrowSS (400 GeV, 50 GeV, 100 mm)', 'l', '', 1, 6)
    plot.addHisto(hist_1000_150_1, 'HIST,SAME', 'H#rightarrowSS (1000 GeV, 150 GeV, 1 mm)', 'l', '', 1, 7)
    plot.addHisto(hist_1000_150_10, 'HIST,SAME', 'H#rightarrowSS (1000 GeV, 150 GeV, 10 mm)', 'l', '', 1, 8)
    plot.addHisto(hist_1000_150_100, 'HIST,SAME', 'H#rightarrowSS (1000 GeV, 150 GeV, 100 mm)', 'l', '', 1, 9)
    ...
    plot.addLine(0.2, hist_bkg.GetMinimum(), 0.2, 0.09, r.kBlack, 2)
    ...
    hist_1000_150_100.SetLineColor(r.kBlue-7)
    hist_1000_150_100.SetLineWidth(2)
    plot = Canvas.Canvas('hist_electron_relPFIso', 'png,pdf', 0.32, 0.55, 0.67, 0.89, 1, lsize=0.028)
    plot.addHisto(hist_bkg, 'HIST', 'Background: Hadronic WZ, WW decays', 'f', '', 1, 0)
    plot.addHisto(hist_125_30_1, 'HIST,SAME', 'H#rightarrowSS (125 GeV, 30 GeV, 1 mm)', 'l', '', 1, 1)
    plot.addHisto(hist_125_30_10, 'HIST,SAME', 'H#rightarrowSS (125 GeV, 30 GeV, 10 mm)', 'l', '', 1, 2)
    plot.addHisto(hist_125_30_100, 'HIST,SAME', 'H#rightarrowSS (125 GeV, 30 GeV, 100 mm)', 'l', '', 1, 3)
    ...
    hist_1000_150_100.SetLineColor(r.kBlue-7)
    hist_1000_150_100.SetLineWidth(2)
    plot = Canvas.Canvas('hist_muon_relPFIso', 'png,pdf', 0.32, 0.55, 0.67, 0.89, 1, lsize=0.028)
    plot.addHisto(hist_bkg, 'HIST', 'Background: Hadronic WZ, WW decays', 'f', '', 1, 0)
    plot.addHisto(hist_125_30_1, 'HIST,SAME', 'H#rightarrowSS (125 GeV, 30 GeV, 1 mm)', 'l', '', 1, 1)
    plot.addHisto(hist_125_30_10, 'HIST,SAME', 'H#rightarrowSS (125 GeV, 30 GeV, 10 mm)', 'l', '', 1, 2)
    plot.addHisto(hist_125_30_100, 'HIST,SAME', 'H#rightarrowSS (125 GeV, 30 GeV, 100 mm)', 'l', '', 1, 3)
    ...
    plot.addLatex(0.75, 0.4, '|#eta| < 2', size = 0.03, align = 22)
    plot.addLine(0.1, hist_bkg.GetMinimum(), 0.11, 0.1, r.kBlack, 2)
    plot.save(1, 0, 0, '', '', outputDir = WORKPATH + 'harvested/', inProgress = False, xlog = True)
